	...
	<div class="container">
		<div class="row">
			<div class="col-lg-2 callout">
				<div id="logo">
					<a href="accueilphp"><img src="logo_noir.png" alt="Logo" width="100px" height="auto"></a>
				</div>
			</div>
			<div class="col-lg-10 callout">
				<h2>Mot de passe oublié</h2>
				<div id="connexion">
					<a href="accueil.php">Accueil</a> > <a href="profil.php">Profil</a> > <a href="mdp_oublie.php">Mot de passe oublié</a>
						</br>
					</br>
